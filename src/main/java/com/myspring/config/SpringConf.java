...
import com.myspring.beans.Color;
import com.myspring.beans.Users;
import com.myspring.conditions.MySelector;
import com.myspring.conditions.WindowsCon;
import com.myspring.beans.ColorFacttoryBean;
...
* Bean作用域:
*  @Scope("singleton"),单例的：
*       IOC容器启动会调用方法创建对象放到IOC容器中，以后需要获取该对象时直接去IOC容器(map.get())中拿
...
@Import({Color.class, MySelector.class})//id默认是全类名
